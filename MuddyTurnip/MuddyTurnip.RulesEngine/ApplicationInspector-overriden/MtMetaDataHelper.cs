...
namespace MuddyTurnip.RulesEngine.Commands
{
    ...
    public class MtMetaDataHelper
    {
        ...
        {
            get { return UniqueTags.Keys.Count; }
        }

        internal MtMetaData Metadata { get; set; }

        public MtMetaDataHelper(string sourcePath)
        {
            ...
            Metadata = new MtMetaData(sourcePath, sourcePath);
        }
        ...
        public void AddTagsFromMatchRecord(MtMatchRecord matchRecord)
        {
        ...
        /// </summary>
        /// <param name="matchRecord"></param>
        public void AddMatchRecord(MtMatchRecord matchRecord)
        {
            //special handling for standard characteristics in report
        ...
        public string DetectSolutionType(MtMatchRecord match)
        {
            string result = "";
